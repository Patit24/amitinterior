...
const localAbsolutePath = /(?<attr>\b(?:href|src)=["'])\/(?!(?:amitinterior|assets)\/)(?<path>(?:admin|about|contact|portfolio|services)(?:\/|#)?|Images\/|Logo\.png|favicon\.ico|Create_a_premium_D_cinematic\.mp4)/g;
